...
const MAX_VISIBLE_COLLEGES = 100;
...
export function CollegePicker({
  ...
  const visibleColleges = matchingColleges.slice(0, MAX_VISIBLE_COLLEGES);
  const hasMoreMatches = matchingColleges.length > visibleColleges.length;
