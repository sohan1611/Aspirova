...
export default function RecentlyViewed() {
  ...
  return (
    <section className="mt-6" aria-labelledby="recently-viewed-heading">
      <div className="flex items-center justify-between gap-3">
        <p id="recently-viewed-heading" className="eyebrow">
          Recently viewed
        </p>
        <Button type="button" variant="ghost" size="sm" onClick={() => clearRecentlyViewed()}>
          Clear
        </Button>
      </div>
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 truncate text-xs font-medium text-muted-foreground">
                {item.companyName ?? "Independent listing"}
              </p>
            </div>
          </Link>
        ))}
