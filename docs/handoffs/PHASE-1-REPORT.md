...
- This combination got a crawl to *complete* (18m36s) but exposed the cascading-failure bug (§4 #5) underneath, which was the real remaining issue — the hangs and the cascading errors were two separate problems that happened to mask each other.
